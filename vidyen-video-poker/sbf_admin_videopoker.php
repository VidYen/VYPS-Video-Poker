...
<?php echo($this->videopoker_shortcode_top()) ?>
 ...
 <a href="javascript:document.getElementById('videopoker_hints').scrollIntoView();"><b><?php _e( 'Scroll to Hints', 'vidyen-video-poker' ); ?></b></a>

<hr>

<?php _e( 'Use Shortcode', 'vidyen-video-poker' ); ?>  <code>[SBFG_VIDEOPOKER]</code>
 <?php _e( 'where you want the game to appear', 'vidyen-video-poker' ); ?> ,
 <?php _e( 'or', 'vidyen-video-poker' ); ?>
 <a href="#" onclick="window.open(top.location.href+'&shortcode=[SBFG_VIDEOPOKER]&name=Video%20Poker');return false;"><?php _e('Generate test Page', 'vidyen-video-poker' ); ?></a>
...
<div id="sfbg_videopoker_settings" style="float: left; padding:10px;">
	...
	<?php _e( 'Cryptoo.me <b>API Key</b>', 'vidyen-video-poker' ); ?>:
	...
	<?php _e( 'Maximum bet', 'vidyen-video-poker' ); ?>:
	...
	<div class='videopoker_comments'>
		<?php _e( 'Limits the losses from very lucky player', 'vidyen-video-poker' ); ?>
	</div>
	<hr>

	<?php _e( 'Initial bonus', 'vidyen-video-poker' ); ?>:
	...
	<?php _e( 'satoshi', 'vidyen-video-poker' ); ?>
	<div class='videopoker_comments'>
		<?php _e( 'Random bonus for new player', 'vidyen-video-poker' ); ?>
	</div>

	<hr>
	<?php _e( 'Bonuses before deposit', 'vidyen-video-poker' ); ?>:
	...
	<div class='videopoker_comments'>
		<?php _e( 'How many times initial bonus is offered', 'vidyen-video-poker' ); ?> <br>
		<?php _e( 'before player has to deposit own satoshi', 'vidyen-video-poker' ); ?>
	</div>
	<hr>

	<?php _e( 'Wins before withdraw', 'vidyen-video-poker' ); ?>:
	...
	<div class='videopoker_comments'>
		<?php _e( 'While playing on bonus money', 'vidyen-video-poker' ); ?>, <br>
		<?php _e( 'the player has to win several times', 'vidyen-video-poker' ); ?>
	</div>
	<hr>
...
&nbsp;-&nbsp;
<?php _e('On long run the house (the website, you) always wins, but it would be wise to keep some satshi on the account to pay the lucky player', 'vidyen-video-poker' ); ?>.
<hr>
&nbsp;-&nbsp;
<?php _e('<a target=_blank href="https://en.wikipedia.org/wiki/Video_poker">Know your game</a>', 'vidyen-video-poker' ); ?>.
<hr>
