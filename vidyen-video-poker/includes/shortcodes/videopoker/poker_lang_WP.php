...
//a_poker.php
	'poker_got_gonus' => __("You've got bonus %n satoshi",'vidyen-video-poker'),
	...
	'you_won' => __("You win %n satoshi",'vidyen-video-poker'),
//poker_util.js	
	'satoshi' => __("satoshi",'vidyen-video-poker'),
	...
	'enter_address' => __("Enter bitcoin address to withdraw your satoshi",'vidyen-video-poker'),
	'enter_amount' => __("Enter amount of satoshi to deposit",'vidyen-video-poker'),
	'incorrect_amount' => __("is incorrect value for satoshi amount",'vidyen-video-poker'),
...
//poker.js - pain in the ass
	...
	'you_have_zero' => __("You have 0 satoshi",'vidyen-video-poker'),
	...
	'bet_to_1' => __("Bet set to 1 satoshi",'vidyen-video-poker'),
	'click_cards_to_reade' => __("Click the cards you want to trade",'vidyen-video-poker'),
	'no_satoshi_reset' => __("You've run out of satoshi! Click 'OK' to reset.",'vidyen-video-poker'),
